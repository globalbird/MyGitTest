...
<head>
	...
	<meta name="keywords" content="<?= get_settings()->blog_meta_keywords ?>" />    
    <!-- Site favicon -->
    ...
    <link rel="stylesheet" type="text/css" href="/backend/vendors/styles/toastr.min.css" />
...
<body>
    ...
    <script src="/extra-assets/sweetalert2/sweetalert2.all.js"></script>
    <script src="/extra-assets/sweetalert2/sweet-alert.init.js"></script>
