        ...
        <div class="user-info-dropdown">
            <div class="dropdown">
                ...
                <span class="user-icon">
								<img src="<?= get_user()->picture == null ? '/images/users/default_avatar.jpg' : '/images/users/'.get_user()->picture ?>" alt="">
							</span><span class="user-name ci-user-name"><?= get_user()->name ?></span>
