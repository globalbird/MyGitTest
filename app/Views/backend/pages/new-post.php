            ...
            <div class="card card-box mb-2">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="content" name="content" cols="30" rows="10" class="form-control" placeholder="Add your content ..." aria-describedby="content_help"></textarea>
                        <div class="form-text" id="content_help"><small class="text-muted">Content must have 20 or more characters</small></div>
            ...
            <div class="card card-box mb-2">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_description" id="" cols="30" rows="10" class="form-control" placeholder="Enter meta description"></textarea>                       
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-box mb-2">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="featured-image" id="" class="form-control-file form-control" height="auto" aria-describedby="featured_image_help">
                                <div class="form-text txt-sm" id="featured_image_help"><small class="text-muted">Use rectangular images no larger than 2MB</small></div>
                        <span class="text-danger error-text featured-image_error"></span>
                    </div>
                    <div class="d-block mb-3" style="max-width:250px;">
                          <img src="" alt="" class="image-thumb" id="image-previewer" data-ijabo-default-img="">      
                    </div>
                    <div class="form-group">
