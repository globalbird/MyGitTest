    ...
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
        <div class="pd-20 card-box height-100-p">
            <div class="profile-photo">
                ...
                <img src="<?= get_user()->picture == null ? '/images/users/default_avatar.jpg' : '/images/users/'.get_user()->picture ?>"
                    alt="" class="ci-avatar-photo avatar-photo">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control current_password" placeholder="Enter current password" name="current_password" class="current_password">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control new_password" placeholder="Enter new password" name="new_password">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control confirm_new_password" placeholder="Retype new password" name="confirm_new_password">
