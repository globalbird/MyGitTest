...
<img loading="lazy" decoding="async" src="/images/posts/thumb_<?php echo $post->featured_image ?>" alt="Post Thumbnail" class="w-100">
                                    <div class="media-body ml-3">
                                        <h3 style="margin-top:-5px"><?= $post->title ?></h3>
                                        <p class="mb-0 small">
                                            <?php echo limit_words($post->content,6)?>
                                        </p>
                                    </div>
                                </a>
                                <?php endforeach ?>
