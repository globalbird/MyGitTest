    ...
    <nav class="navbar navbar-expand-lg navbar-light px-0">
      ...
      <div class="collapse navbar-collapse text-center order-lg-2 order-4" id="navigation">
        <ul class="navbar-nav mx-auto mt-3 mt-lg-0">
          ...
          <?php endforeach ?>
          <?php foreach( get_dependant_subcategories() as $subcategory ) : ?>
          <li class="nav-item"> <a class="nav-link" href="<?= route_to('category-post',$subcategory->slug) ?>"><?= $subcategory->name ?></a>
          <?php endforeach ?>
