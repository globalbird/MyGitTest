...
class AuthController extends BaseController
{
    ...
    public function loginHandler()
    {
            ...
            $isValid = $this->validate([
                'login_id'=>[
                    ...
                    'errors'=>[
                        ...
                        'is_not_unique'=>'Your email does not exist on our system.'
                    ]
                ],
                'password'=>[
                    ...
                    'errors'=>[
                        ...
                        'max_length'=>'Your password has too many characters.'
            ...
            $isValid = $this->validate([
                'login_id'=>[
                    ...
                    'errors'=>[
                        ...
                        'is_not_unique'=>'Username does not exist on our system.'
                    ]
                ],
                'password'=>[
            ...
            $isValid = $this->validate([
                'email' => [
                    ...
                    'errors' => [
                        ...
                        'is_not_unique' => 'Email does not exist on our system.'
                    ],
                ]
                ]);
                ...
                if(!$isValid){
                    ...
                    if( sendEmail($mailConfig) ){
                        return redirect()->route('admin.forgot.form')->with('success','We have emailed your password reset link'); // MX-> Why is this not showing on form?
                    }else{
        ...
        public function resetPassword($token){
            ...
            if( !$check_token ){
                return redirect()->route('admin.forgot.form')->with('fail', 'Invalid security token. Please request another reset password link.');
            }else{
                // Check if token is not expired (Older than 15 minutes)
                $diffMins = Carbon::createFromFormat('Y-m-d H:i:s', $check_token->created_at)->diffInMinutes(Carbon::now());

                if( $diffMins > 15){
                // If token expered (older than 15 mins)
                return redirect()->route('admin.forgot.form')->with('fail', 'Token expired. Please request another reset password link.');
                }else{
            ...
            $isValid = $this->validate([
                'new_password'=>[
                    ...
                    'errors'=>[
                        ...
                        'max_length'=>'Password may only have 20 characters or less.',
            ...
            if( !$isValid ){
                ...
                if( !$get_token ){
                    ...
                    if( sendEmail($mailConfig) ){
                        ...
                        return redirect()->route('admin.login.form')->with('success','Done! Your password has been changed. Use your new password to login to the system.'); // MX-> Why is this not showing on form?
                    }else{
